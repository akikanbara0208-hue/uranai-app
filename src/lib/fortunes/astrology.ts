...
export function getAstrologyReading(birthday: string, birthHour?: number, lat: number = TOKYO.lat, lon: number = TOKYO.lon): FortuneResult {
  ...
  const chartWheel: ChartWheelData = {
    planets: [
      { key: "sun", label: "太陽", symbol: "☉", longitude: getSunLongitude(jd) },
      { key: "moon", label: "月", symbol: "☽", longitude: getMoonLongitude(jd) },
      { key: "mercury", label: "水星", symbol: "☿", longitude: getPlanetLongitude(jd, "mercury") },
      { key: "venus", label: "金星", symbol: "♀", longitude: getPlanetLongitude(jd, "venus") },
      { key: "mars", label: "火星", symbol: "♂", longitude: getPlanetLongitude(jd, "mars") },
      { key: "jupiter", label: "木星", symbol: "♃", longitude: getPlanetLongitude(jd, "jupiter") },
      { key: "saturn", label: "土星", symbol: "♄", longitude: getPlanetLongitude(jd, "saturn") },
      { key: "uranus", label: "天王星", symbol: "♅", longitude: getPlanetLongitude(jd, "uranus") },
      { key: "neptune", label: "海王星", symbol: "♆", longitude: getPlanetLongitude(jd, "neptune") },
      { key: "pluto", label: "冥王星", symbol: "♇", longitude: getPlanetLongitude(jd, "pluto") },
    ],
    ascendant: hasTime ? getAscendantLongitude(jd, birthHour!, lat, lon) : undefined,
